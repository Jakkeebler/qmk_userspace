...
// Dance Functions
// Dance Caps
void on_dance_CAPS(tap_dance_state_t *state, void *user_data) {
    // Used for Immediate Actions
}

void dance_CAPS_finished(tap_dance_state_t *state, void *user_data) {
    dance_state[DANCE_CAPS] = dance_step(state);
    switch (dance_state[DANCE_CAPS]) {
        case TD_SINGLE_TAP:
...
tap_dance_action_t tap_dance_actions[] = {
        [DANCE_CAPS] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_CAPS, dance_CAPS_finished, dance_CAPS_reset),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_GRV,         TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    KC_4,           TD(DANCE_5),    KC_6,           TD(DANCE_7),    TD(DANCE_8),    KC_9,           TD(DANCE_0),    TD(DANCE_MINS), TD(DANCE_EQL),  KC_INT3,    KC_BSPC, KC_INS,  KC_HOME, KC_PGUP,     KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,    KC_STOP, KC_AGIN,
    KC_TAB,         TD(DANCE_Q),    TD(DANCE_W),    TD(DANCE_E),    TD(DANCE_R),    TD(DANCE_T),    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           TD(DANCE_LBRC), TD(DANCE_RBRC), KC_BSLS,             KC_DEL,  KC_END,  KC_PGDN,     KC_P7,   KC_P8,   KC_P9,   KC_PPLS,    KC_MENU, KC_UNDO,
    TD(DANCE_CAPS), TD(DANCE_A),    TD(DANCE_S),    KC_D,           TD(DANCE_F),    TD(DANCE_G),    KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOT,        KC_NUHS,        KC_ENT,                                             KC_P4,   KC_P5,   KC_P6,   KC_PCMM,    KC_SLCT, KC_COPY,
    KC_LSFT,        KC_NUBS,        TD(DANCE_Z),    TD(DANCE_X),    TD(DANCE_C),    TD(DANCE_V),    TD(DANCE_B),    TD(DANCE_N),    KC_M,           KC_COMM,        KC_DOT,         KC_SLSH,        KC_INT1,        KC_RSFT,                KC_UP,                      KC_P1,   KC_P2,   KC_P3,   KC_PEQL,    KC_EXEC, KC_PSTE,
    KC_LCTL,        KC_LGUI,        KC_LALT,        KC_INT5,        KC_LNG2,        KC_SPC,         KC_LNG1,        KC_INT4,        KC_INT2,        KC_LALT,        KC_LGUI,        KC_APP,         KC_RCTL,                       KC_LEFT, KC_DOWN, KC_RGHT,           KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
};
